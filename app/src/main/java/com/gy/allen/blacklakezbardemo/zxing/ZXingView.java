package com.gy.allen.blacklakezbardemo.zxing;
...
public class ZXingView extends QRCodeView{
    ...
    public ZXingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        initMultiFormateReader();
    }

    private void initMultiFormateReader() {
    ...
    public String processData(byte[] data, int width, int height, boolean isRetry) {
        ...
        try {
            ...
            rawResult = mMultiFormatReader.decode(new BinaryBitmap(new HybridBinarizer(source)));
        } catch (Exception e) {
            e.printStackTrace();
        }finally {
